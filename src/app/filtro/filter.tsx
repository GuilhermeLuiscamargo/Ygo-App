...
export default function Filtro({ cards }: individualCardProps) {
  ...
  return (
    <main className="mainFiltroTag">
      <div className="formDivFilterTag">
        <form
          action="submit"
          onSubmit={(ev) => {
            ev.preventDefault();
        ...
        >
          ...
          <div className="attributeDivSelect">
            <select
          ...
          <div className="archtypeDivSelect">
            <select
          ...
          <div className="valuesDivSelect">
            ...
            <div className="form-linkValue">
              ...
              />
              <label htmlFor="linkLabel">Link</label>
            </div>
            <div className="form-scalePendulumValue">
              <input
                type="number"
                id="scaleLabel"
                value={scale}
              ...
              />
              <label htmlFor="scaleLabel">Scale</label>
            </div>
          </div>
      ...
      <div className="CardResultsFilterTag">
        <CardList cards={data} />
        {data ? (
          <>
